...
public class SimpleLinearRegression {
    ...
    /**
     * Constructs instance of SimpleLinearRegression which finds best fitting line for the given <em>values</em> and <em>outputs</em>.
     *
     * @param values  from which to learn coefficients
     * @param outputs associated with values
     * @throws IllegalArgumentException if <em>values</em> and <em>outputs</em> are of different dimension
     */
