...
//    private final Vocabulary vocabulary; // vocabulary of allowed dense features
...
//        this.vocabulary = denseVocabulary;
...
//        // this won't work due to memory cost, need refactor
//        // double[] denseFeatures = TF_IDF_Vectorizer.vectorize(dense, vocabulary);
//        double[] denseFeatures = new double[0];
