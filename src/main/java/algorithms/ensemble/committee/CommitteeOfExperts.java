 ...
 * </p>
 *
 * The class offers two methods, {@link #classify(double[])} which returns most voted class given algorithms.ensemble model of
 * classifiers and {@link #estimate(double[])} which estimates explanatory variables as average of algorithms.ensemble model classifiers.
 *
 * @author dtemraz
 */
public class CommitteeOfExperts {
    ...
    private final List<Model> ensembleModel;  // algorithms.ensemble classifier where each classifier is equally important
    ...
    // each model in algorithms.ensemble votes for data class and the class with most votes is chosen as target class
